...
class Pegawai_Model extends Model
{
    ...
    {
        $column_order = array('pegawai.`pegawai_nip`', 'pembagian3.`pembagian3_nama`', 'pegawai.`pegawai_nama`', 'pembagian2.`pembagian2_nama`', 'pembagian4.`pembagian4_nama`', 'pegawai.`tgl_mulai_kerja`', 'pegawai.`grup_t`');
        $column_search = array('pegawai.`pegawai_nip`', 'pembagian3.`pembagian3_nama`', 'pegawai.`pegawai_nama`', 'pembagian2.`pembagian2_nama`', 'pembagian4.`pembagian4_nama`', 'pegawai.`tgl_mulai_kerja`', 'pegawai.`grup_t`');
        $order = array('pegawai.`pegawai_id`' => 'desc');

        $this->select('pegawai.`pegawai_nip` as idkar, pembagian3.`pembagian3_nama` as vendor, pegawai.`pegawai_nama` as nama, pembagian2.`pembagian2_nama` as bagian, pembagian4.`pembagian4_nama` as unit, pegawai.`tgl_mulai_kerja` as tmt, pegawai.`grup_t` as grup_t');
